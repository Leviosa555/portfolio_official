    ...
    <section id="certificates" className="bg-black py-24 px-4 md:px-8 border-t border-white/5 relative z-10 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden lg:block relative w-full overflow-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-28 bg-gradient-to-r from-black via-black/40 to-transparent pointer-events-none z-20" />
          <div className="absolute right-0 top-0 bottom-0 w-28 bg-gradient-to-l from-black via-black/40 to-transparent pointer-events-none z-20" />
            ...
            <div ref={set1Ref} className="flex gap-6 pr-6 shrink-0">
              {certificates.map((cert, index) => (
                <div
                  ...
                  className="w-[310px] h-[220px] shrink-0 group perspective-1000"
                >
        ...
        <div className="block lg:hidden w-full relative">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-8 py-6">
            ...
            <div className="w-[290px] h-[210px] sm:w-[310px] sm:h-[220px] relative perspective-1000">
