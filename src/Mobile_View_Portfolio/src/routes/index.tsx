...
import { Reveal, Stagger, StaggerItem, Tap } from "@/components/Reveal";
import { SplitText } from "@/components/SplitText";
import { ThemeToggle } from "@/components/ThemeToggle";

import avatar from "@/assets/avatar.jpg";
import project1 from "@/assets/project-1.jpg";
import formcraftShot from "@/assets/fromcraft.png";
import campusdriveShot from "@/assets/campusdrive.png";
import cyberscanShot from "@/assets/cyberscan.png";
import resume from "@/assets/resume.pdf";
import infosysLogo from "@/assets/Infosys-Springboard.webp";
import roomanLogo from "@/assets/Rooman.webp";
import excelerateLogo from "@/assets/Excelerate.png";
import vaultLogo from "@/assets/vaultofcodes.jpg";
import eyesecLogo from "@/assets/eyesec.jpg";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Mohammed Junaid Betgeri — CSE Portfolio" },
      {
        name: "description",
        content:
          "Mohammed Junaid Betgeri — Computer Science engineer skilled in full-stack development, data analytics and cybersecurity. Projects, internships, skills and certifications.",
      },
      { property: "og:title", content: "Mohammed Junaid Betgeri — CSE Portfolio" },
      {
        property: "og:description",
        content:
          "CSE graduate working across React, Python, SQL, Power BI and cybersecurity. See projects, internships and certifications.",
      },
    ...
    <div className="flex gap-2">
      {socials.map(({ Icon, href, label }) => (
        <a
          ...
          aria-label={label}
          className={`${box} flex items-center justify-center rounded-full border border-border bg-card`}
        >
          <Icon className={icon} />
        </a>
      ))}
...
function Index() {
  return (
    <div className="min-h-screen bg-background">
      <main className="mx-auto w-full max-w-[430px] px-4 pb-4 pt-4">
        ...
        <Reveal id="work" className="mt-4">
          <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-1">
            ...
            <a href="https://github.com/Leviosa555" target="_blank" rel="noopener noreferrer" className="btn-dark shrink-0 px-4 py-2 text-xs">
              GitHub
            </a>
          </div>
            ...
            {caseStudies.map((c) => (
              <StaggerItem key={c.title}>
                <article className="panel p-5">
                  ...
                  {/*
                  <a href="https://github.com/Leviosa555" target="_blank" rel="noopener noreferrer" className="btn-dark mt-4 w-full px-5 py-3 text-sm">
                  ...
                  <div className="grid grid-cols-[auto_minmax(0,1fr)] gap-3">
                    <div className="grid size-14 shrink-0 place-items-center self-start overflow-hidden rounded-2xl bg-white p-1.5 ring-1 ring-border">
                      {j.logo ? (
                        ...
                        <span className="text-2xl font-extrabold text-foreground">{j.org.charAt(0)}</span>
                      )}
                    </div>
          ...
          <div className="overflow-hidden rounded-2xl bg-card shadow-[var(--shadow-float)]">
            ...
            <div className="grid grid-cols-2 border-t border-border text-[13px] font-semibold">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 border-r border-border py-3.5"
              >
