...
export const About: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        frame,
        { width: "45vmin", height: "60vmin", borderRadius: "2rem", force3D: true },
        { width: "100vw", height: "100vh", borderRadius: "0rem", ease: "power2.inOut", force3D: true },
        0,
      );

      // Fade out centered "About me" label during card scale-up
      if (centerLabel) {
        tl.to(centerLabel, { scale: 1.3, opacity: 0, ease: "power2.in", force3D: true }, 0);
      }

      // Fade out top kicker
      if (kicker) tl.to(kicker, { yPercent: -140, opacity: 0, ease: "power2.in", force3D: true }, 0.1);
      ...
      if (caption) {
        tl.fromTo(
          ...
          { yPercent: 0, opacity: 1, ease: "power2.out", force3D: true },
          0.45,
        );
      }
      ...
      if (titleChars.length > 0) {
        tl.to(
          titleChars,
          { opacity: 1, stagger: 0.003, ease: "none", force3D: true },
          0.5,
        );
      }
  ...
  return (
    ...
    >
      ...
      <div
        data-kicker
        className="absolute left-1/2 top-[12%] z-20 -translate-x-1/2 text-[10px] uppercase tracking-[0.5em] text-primary select-none font-bold will-change-transform"
      >
      ...
      <div className="relative flex h-full w-full items-center justify-center">
        <div
          data-frame
          className="relative overflow-hidden bg-[#101010] border border-white/5 shadow-2xl flex items-center justify-center will-change-transform"
          style={{
            width: "45vmin",
            height: "60vmin",
            borderRadius: "2rem",
        ...
        >
          ...
          >
            ...
            <div className="max-w-2xl mx-auto mt-8 sm:mt-12">
              <p
                className="text-xs sm:text-sm md:text-base leading-relaxed tracking-wide text-center font-light text-foreground/80"
              >
