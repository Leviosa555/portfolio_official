...
export const Internship: React.FC = () => {
  const experiences: InternshipExperience[] = [
    ...
    },
    {
      ...
      description: "Completed structured training across the full data analytics lifecycle including collection, cleaning, and visualization. Practiced SQL joins, subqueries, and query optimization. Applied Python (NumPy, Pandas, Matplotlib, Seaborn) for exploratory data analysis and built interactive dashboards and DAX-based KPIs in Power BI."
    },
    {
      ...
      description: "Conducted collaborative data analysis with a cross-functional virtual team to derive insights from real-world datasets. Performed data cleaning, transformation, and exploratory analysis using statistical techniques to identify trends. Recognized as a Star Performer for outstanding achievement."
    },
    {
      ...
      location: "Remote",
      period: "Aug 2025 – Sep 2025",
      description: "Built and deployed responsive web pages using HTML, CSS, and JavaScript, ensuring clean UI and smooth UX. Integrated front-end features and interactive elements to enhance usability. Gained exposure to modern frameworks like React and Tailwind."
    },
    {
      role: "Cyber Security Intern",
      company: "Eyesec CyberSecurity Pvt Ltd",
      location: "Belgaum, India",
      period: "Mar 2023 – May 2023",
      description: "Worked on real-world cybersecurity labs using HackTheBox. Gained hands-on experience with Burp Suite and vulnerability assessments. Gained exposure to network analysis tools such as Wireshark, and learned core exploitation and vulnerability discovery techniques."
    }
  ];
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex mb-4">
                        <span className="internship-period-pill flex items-center gap-1.5 text-[10px] tracking-wider uppercase font-bold font-mono text-primary bg-black/45 border border-primary/20 px-3.5 py-1.5 rounded-full shadow-inner select-none w-max">
