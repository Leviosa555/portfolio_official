          ...
          <AnimatePresence>
            {tooltip.show && (
              <motion.div
                ...
                className="fixed pointer-events-none z-[100] flex items-center gap-2 font-bold px-4 py-2.5 rounded-full shadow-2xl"
                style={{
                  left: tooltip.x,
                  top: tooltip.y,
                  x: "-50%",
              ...
              >
                ...
                <span className="text-sm font-sans tracking-wide" style={{ color: "#ffffff" }}>{tooltip.text}</span>
              </motion.div>
            )}
          </AnimatePresence>
